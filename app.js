...
/* ============================================================
   ...
   ============================================================ */
const INLINE_APPS = [
  // === TOP: the most fun interactive apps ===
...
function fireConfetti() {
  ...
  const pieces = [];
  const colors = ["#ef4444", "#f97316", "#eab308", "#22c55e", "#3b82f6", "#8b5cf6", "#06b6d4", "#fff"];
...
function card(app, index) {
  ...
  el.innerHTML = `
    ...
    <h3><span class="card-number">#${num}</span><span class="kids-emoji">${app.emoji}</span><span class="kids-name">${app.name}</span></h3>
